...
func TestNestedNilPointer(t *testing.T) {
	...
	_ = structs.Map(person)                  // Panics
	_ = structs.Map(personWithDog)           // Panics
	_ = structs.Map(personWithDogWithCollar) // Doesn't panic
}
